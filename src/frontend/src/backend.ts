...
export class Backend implements backendInterface {
    ...
    async getAllVendorInquiries(): Promise<Array<VendorInquiry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllVendorInquiries();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getVendorInquiriesByMaterialType(arg0: string): Promise<Array<VendorInquiry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getVendorInquiriesByMaterialType(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitVendorInquiry(arg0: VendorInquiry): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitVendorInquiry(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
